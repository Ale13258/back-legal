...
export class ListGestionesUseCase {
  ...
  async execute(input: { auth: AuthContext; propiedadId: string }): Promise<Gestion[]> {
    ...
    return this.deps.propiedadesPersistence.listGestionesByPropiedadId(input.propiedadId);
  }
}
